...
```bash
$ git clone git@gitlab.com:uminho-di/li1/2223/2022li1g014.git
$ cd 2022li1g014
```
...
```bash
$ git clone https://gitlab.com/uminho-di/li1/2223/projetos/2022li1g014.git
$ cd 2022li1g014
```
...
- **A104079** Gonçalo da Silva Alves;
